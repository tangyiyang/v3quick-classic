...
function DeprecatedExtensionClass.CCEditBox()
    deprecatedTip("CCEditBox","cc.ui.EditBox")
    return cc.ui.EditBox
end
_G["CCEditBox"] = DeprecatedExtensionClass.CCEditBox()

function DeprecatedExtensionClass.cc.uiEditBox()
    deprecatedTip("cc.EditBox","cc.ui.EditBox")
    return cc.ui.EditBox
end
_G["cc"]["EditBox"] = DeprecatedExtensionClass.cc.uiEditBox()
...
function DeprecatedExtensionClass.CCScale9Sprite()
    deprecatedTip("CCScale9Sprite","cc.ui.Scale9Sprite")
    return cc.ui.Scale9Sprite
end
_G["CCScale9Sprite"] = DeprecatedExtensionClass.CCScale9Sprite()

function DeprecatedExtensionClass.UIScale9Sprite()
    deprecatedTip("cc.Scale9Sprite","cc.ui.Scale9Sprite")
    return cc.ui.Scale9Sprite
end
